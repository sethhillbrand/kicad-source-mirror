...
KICAD_T FromProtoEnum( types::KiCadObjectType aValue )
{
    ...
    case types::KiCadObjectType::KOT_SCH_NETCHAIN_LABEL:      return SCH_NETCHAIN_LABEL_T;
...
types::KiCadObjectType ToProtoEnum( KICAD_T aValue )
{
    ...
    case SCH_NETCHAIN_LABEL_T:     return types::KiCadObjectType::KOT_SCH_NETCHAIN_LABEL;
