                     ...
                     wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER )
{
    ...
    grid->Add( new wxStaticText( this, wxID_ANY, _( "Connection String" ) ), 0, wxALIGN_CENTER_VERTICAL );

    topSizer->Add( grid, 0, wxEXPAND | wxLEFT | wxRIGHT | wxBOTTOM, 5 );
    m_connStrCtrl = new wxTextCtrl( this, wxID_ANY );
    topSizer->Add( m_connStrCtrl, 1, wxEXPAND, 5 );
...
wxString DIALOG_GENERATE_DATABASE_CONNECTION::GetFileName() const
{
    // TODO: save the database data to a file and return the file name
