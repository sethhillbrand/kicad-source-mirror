...
void SCH_PAINTER::draw( const EDA_ITEM* aItem, int aLayer, bool aDimmed )
{
    ...
    case SCH_NETCHAIN_LABEL_T:
        draw( static_cast<const SCH_NETCHAIN_LABEL*>( aItem ), aLayer, aDimmed );
        break;
...
void SCH_PAINTER::draw( const SCH_TEXT* aText, int aLayer, bool aDimmed )
{
    ...
    case SCH_NETCHAIN_LABEL_T:    aLayer = LAYER_LOCLABEL;                          break;
    ...
    if( aText->IsSelected() )
    {
        ...
        case SCH_NETCHAIN_LABEL_T:
            // Don't clutter things up if we're already showing a dangling indicator
            showAnchor = !static_cast<const SCH_NETCHAIN_LABEL*>( aText )->IsDangling();
            break;
...
void SCH_PAINTER::draw( const SCH_NETCHAIN_LABEL* aLabel, int aLayer, bool aDimmed )
{
    bool drawingShadows = aLayer == LAYER_SELECTION_SHADOWS;
