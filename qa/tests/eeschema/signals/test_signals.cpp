...
BOOST_FIXTURE_TEST_CASE( RebuildNetChains_GroupsFourNetsIntoOneChain, SIGNALS_TEST_FIXTURE )
{
    LOCALE_IO dummy;
...
BOOST_FIXTURE_TEST_CASE( RebuildSignals_RespectsNetChainLabelAndKeepsGrouping, SIGNALS_TEST_FIXTURE )
{
    LOCALE_IO dummy;
