...
class DIALOG_TRACK_VIA_PROPERTIES_BASE : public DIALOG_SHIM
{
	...
	protected:
		...
		wxStaticText* m_ViaDiameterUnit;
                ...
                wxCheckBox* m_ViaDrillPostMachining;
                wxStaticText* m_ViaBackdrillLabel;
                wxTextCtrl* m_ViaBackdrillCtrl;
                wxStaticText* m_ViaBackdrillUnit;
                ...
                wxCheckBox* m_ViaBackdrillPostMachining;
                wxStaticText* m_ViaBackdrillStartLayerLabel;
                PCB_LAYER_BOX_SELECTOR* m_ViaBackdrillStartLayer;
                wxStaticText* m_ViaBackdrillEndLayerLabel;
                PCB_LAYER_BOX_SELECTOR* m_ViaBackdrillEndLayer;
