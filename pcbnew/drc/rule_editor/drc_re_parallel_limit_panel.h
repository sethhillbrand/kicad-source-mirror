...
class DRC_RE_PARALLEL_LIMIT_PANEL : public DRC_RE_PARALLEL_LIMIT_PANEL_BASE,
                                    public DRC_RULE_EDITOR_CONTENT_PANEL_BASE
{
public:
    DRC_RE_PARALLEL_LIMIT_PANEL( wxWindow* aParent, wxString* aConstraintTitle,
...
private:
    std::shared_ptr<DRC_RE_PARALLEL_LIMIT_CONSTRAINT_DATA> m_constraintData;
};
