...
DRC_RE_CORNER_STYLE_PANEL_BASE::DRC_RE_CORNER_STYLE_PANEL_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText13 = new wxStaticText( this, wxID_ANY, _("Corner Style"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	sbSizer1 = new wxStaticBoxSizer( new wxStaticBox( this, wxID_ANY, _("Setback") ), wxVERTICAL );
	...
	bConstraintContentSizer->Add( sbSizer1, 1, 0, 5 );
...
DRC_RE_CORNER_STYLE_PANEL_BASE::~DRC_RE_CORNER_STYLE_PANEL_BASE()
{
}
