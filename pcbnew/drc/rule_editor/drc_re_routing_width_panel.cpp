...
{
    if( !DRC_RULE_EDITOR_UTILS::ValidateNumericCtrl( m_minRoutingWidthTextCtrl,
                                                     "Minimum Routing Width", false, aErrorCount,
                                                     aValidationMessage ) )
        return false;

    if( !DRC_RULE_EDITOR_UTILS::ValidateNumericCtrl( m_preferredRoutingWidthTextCtrl,
                                                     "Preferred Routing Width", false, aErrorCount,
                                                     aValidationMessage ) )
        return false;

    if( !DRC_RULE_EDITOR_UTILS::ValidateNumericCtrl( m_maxRoutingWidthTextCtrl,
                                                     "Maximum Routing Width", false, aErrorCount,
                                                     aValidationMessage ) )
        return false;

    if( !DRC_RULE_EDITOR_UTILS::ValidateMinPreferredMaxCtrl( m_minRoutingWidthTextCtrl, 
                m_preferredRoutingWidthTextCtrl, m_maxRoutingWidthTextCtrl, "Minimum Routing Width", 
                "Preferred Routing Width", "Maximum Routing Width", aErrorCount, aValidationMessage ) )
        return false;
