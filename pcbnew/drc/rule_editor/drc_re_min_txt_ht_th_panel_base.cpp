...
DRC_RE_MINIMUM_TEXT_HEIGHT_THICKNESS_PANEL_BASE::DRC_RE_MINIMUM_TEXT_HEIGHT_THICKNESS_PANEL_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_textMinimumTextHeight = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize( -1,-1 ), 0 );
	fgSizer3->Add( m_textMinimumTextHeight, 0, wxALL|wxEXPAND|wxRIGHT, 5 );
	...
	m_textMinimumTextThickness = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	fgSizer3->Add( m_textMinimumTextThickness, 0, wxALL, 5 );
