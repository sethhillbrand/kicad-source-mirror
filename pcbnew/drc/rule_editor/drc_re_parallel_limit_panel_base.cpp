...
DRC_RE_PARALLEL_LIMIT_PANEL_BASE::DRC_RE_PARALLEL_LIMIT_PANEL_BASE( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	m_staticText1 = new wxStaticText( this, wxID_ANY, _("Parallel Gap"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText3 = new wxStaticText( this, wxID_ANY, _("Parallel Limit"), wxDefaultPosition, wxDefaultSize, 0 );
...
DRC_RE_PARALLEL_LIMIT_PANEL_BASE::~DRC_RE_PARALLEL_LIMIT_PANEL_BASE()
{
}
