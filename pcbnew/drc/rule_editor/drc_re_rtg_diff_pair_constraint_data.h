...
public:
    ...
    explicit DrcReRoutingDiffPairConstraintData( unsigned int aId, unsigned int aParentId,
                                                double aClearanceValue, wxString aRuleName) :
            DrcReBaseConstraintData( aId, aParentId, aRuleName ),
            m_routingDiffPair( aClearanceValue )
    {
    }
    ...
    void   SetRoutingDiffPair( double aRoutingDiffPair ) { m_routingDiffPair = aRoutingDiffPair; }
