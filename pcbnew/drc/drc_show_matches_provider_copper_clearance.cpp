...
class DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE : public DRC_TEST_PROVIDER_CLEARANCE_BASE
{
public:
    DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE () :
            DRC_TEST_PROVIDER_CLEARANCE_BASE(),
            m_drcEpsilon( 0 )
    {
    }

    virtual ~DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE()
    {
    }
...
bool DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::Run()
{
...
bool DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::testSingleLayerItemAgainstItem( BOARD_ITEM* item,
                                                                         SHAPE* itemShape,
                                                                         PCB_LAYER_ID layer,
                                                                         BOARD_ITEM* other )
{
...
void DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::testItemAgainstZone( BOARD_ITEM* aItem, ZONE* aZone,
                                                              PCB_LAYER_ID aLayer )
{
 ...
 */
void DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::testKnockoutTextAgainstZone( BOARD_ITEM* aText,
...
void DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::testTrackClearances()
{
...
void DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::testPadAgainstItem( PAD* pad, SHAPE* padShape,
                                                             PCB_LAYER_ID aLayer,
                                                             BOARD_ITEM* other )
{
    bool testClearance = !m_drcEngine->IsErrorLimitExceeded( DRCE_CLEARANCE );
...
void DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::testPadClearances( )
{
    thread_pool&        tp = GetKiCadThreadPool();
    size_t              count = 0;
...
void DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::testGraphicClearances( )
{
    thread_pool&        tp = GetKiCadThreadPool();
...
void DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE::testZonesToZones()
{
    bool           testClearance = !m_drcEngine->IsErrorLimitExceeded( DRCE_CLEARANCE );
...
namespace detail
{
static DRC_REGISTER_SHOWMATCHES_PROVIDER<DRC_SHOWMATCHES_PROVIDER_COPPER_CLEARANCE> dummy;
}
