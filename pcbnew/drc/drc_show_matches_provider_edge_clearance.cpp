...
class DRC_SHOWMATCHES_PROVIDER_EDGE_CLEARANCE : public DRC_TEST_PROVIDER_CLEARANCE_BASE
{
public:
    DRC_SHOWMATCHES_PROVIDER_EDGE_CLEARANCE () :
            DRC_TEST_PROVIDER_CLEARANCE_BASE(),
            m_largestEdgeClearance( 0 )
    {
    }

    virtual ~DRC_SHOWMATCHES_PROVIDER_EDGE_CLEARANCE()
    {
    }
...
bool DRC_SHOWMATCHES_PROVIDER_EDGE_CLEARANCE::testAgainstEdge( BOARD_ITEM* item, SHAPE* itemShape,
                                                        BOARD_ITEM* edge,
...
bool DRC_SHOWMATCHES_PROVIDER_EDGE_CLEARANCE::Run()
{
...
namespace detail
{
static DRC_REGISTER_SHOWMATCHES_PROVIDER<DRC_SHOWMATCHES_PROVIDER_EDGE_CLEARANCE> dummy;
}
