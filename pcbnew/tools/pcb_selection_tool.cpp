...
class NETCHAIN_MENU : public ACTION_MENU
{
public:
    NETCHAIN_MENU() : ACTION_MENU( true )
    {
...
protected:
    ACTION_MENU* create() const override { return new NETCHAIN_MENU(); }
...
bool PCB_SELECTION_TOOL::Init()
{
    ...
    std::shared_ptr<NETCHAIN_MENU> netChainsMenu = std::make_shared<NETCHAIN_MENU>();
