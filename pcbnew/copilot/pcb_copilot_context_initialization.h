...
#include <copilot/kicad_copilot_helper.h>


/**
 * Initialize the copilot context for PCB editor.
 */
void PCB_EDIT_FRAME::InitCopilotContext()
{
    init_copilot_context( *m_copilotContextCache, KICAD_COPILOT_EDITORS::pcb );
}
