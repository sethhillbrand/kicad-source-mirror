...
/**
 * Compute the aggregate routed length (track + pad-to-die) of all nets belonging to a net chain,
...
/**
 * Compute the aggregate routed delay (ps internal units) for all nets in a net chain excluding
