...
public:
    ...
    void SetHolePostMachining( const std::optional<bool>& aPostMachining )
    {
        m_primaryPostMachining = aPostMachining;
    }

    std::optional<bool> HolePostMachining() const { return m_primaryPostMachining; }
    ...
    void SetSecondaryHolePostMachining( const std::optional<bool>& aPostMachining )
    {
        m_secondaryPostMachining = aPostMachining;
    }

    std::optional<bool> SecondaryHolePostMachining() const
    {
...
private:
    ...
    std::optional<bool> m_primaryPostMachining;
    std::optional<bool> m_secondaryPostMachining;
};
