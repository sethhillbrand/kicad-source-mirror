...
public:
    ...
    */
    ...
    /**
     * @return true if this net is part of a differential pair.
     */
    bool HasDiffPair() const { return !m_diffPair.IsEmpty(); }

    /**
     * Set the name of the differential pair this net belongs to.
     */
    void SetDiffPair( const wxString& aName ) { m_diffPair = aName; }

    /**
     * @return the differential pair name for this net.
     */
    const wxString& GetDiffPair() const { return m_diffPair; }
...
private:
    ...
    wxString    m_diffPair;        ///< Name of the differential pair this net belongs to.
