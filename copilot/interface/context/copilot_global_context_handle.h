...
using SELECTION_HDL_T = std::function<std::string()>;
using COPILOT_SELECTION_HDL = std::weak_ptr<std::function<std::string()>>;
using COPILOT_SELECTION_OWNED_HDL = std::shared_ptr<std::function<std::string()>>;
