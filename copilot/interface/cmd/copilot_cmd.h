...
struct DESIGN_INTENTION : CMD_NO_CONTEXT<COPILOT_CMD_TYPE::DESIGN_INTENTION>
{
};

struct CORE_COMPONENTS : CMD_NO_CONTEXT<COPILOT_CMD_TYPE::CORE_COMPONENTS>
{
};
...
struct SIMILAR_COMPONENTS : CMD_WITH_CONTEXT<COPILOT_CMD_TYPE::SIMILAR_COMPONENTS, SYMBOL_CMD_CONTEXT>
{
};
