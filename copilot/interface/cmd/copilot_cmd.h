...
struct DESIGN_INTENTION : CMD_BASE
{
    ...
    COPILOT_CMD_TYPE      type = COPILOT_CMD_TYPE::DESIGN_INTENTION;
...
{
    DESIGN_GLOBAL_CONTEXT context;
    COPILOT_CMD_TYPE      type = COPILOT_CMD_TYPE::CORE_COMPONENTS;
...
struct CURRENT_COMPONENT : CMD_BASE
{
    ...
    COPILOT_CMD_TYPE   type = COPILOT_CMD_TYPE::CURRENT_COMPONENT;
...
{
    SYMBOL_CMD_CONTEXT context;
    COPILOT_CMD_TYPE   type = COPILOT_CMD_TYPE::SIMILAR_COMPONENTS;
    NLOHMANN_DEFINE_TYPE_INTRUSIVE( SIMILAR_COMPONENTS, context, type )
};

struct CHECK_SYMBOL_CONNECTIONS : CMD_BASE
{
    SYMBOL_CMD_CONTEXT context;
    COPILOT_CMD_TYPE   type = COPILOT_CMD_TYPE::CHECK_SYMBOL_CONNECTIONS;
    NLOHMANN_DEFINE_TYPE_INTRUSIVE( CHECK_SYMBOL_CONNECTIONS, context, type )
};

struct COMPONENT_PINS_DETAILS : CMD_BASE
{
    SYMBOL_CMD_CONTEXT context;
    COPILOT_CMD_TYPE   type = COPILOT_CMD_TYPE::COMPONENT_PINS_DETAILS;
    NLOHMANN_DEFINE_TYPE_INTRUSIVE( COMPONENT_PINS_DETAILS, context, type )
};

struct SYMBOL_UNCONNECTED_PINS : CMD_BASE
{
    SYMBOL_CMD_CONTEXT context;
    COPILOT_CMD_TYPE   type = COPILOT_CMD_TYPE::SYMBOL_UNCONNECTED_PINS;
    NLOHMANN_DEFINE_TYPE_INTRUSIVE( SYMBOL_UNCONNECTED_PINS, context, type )
};
